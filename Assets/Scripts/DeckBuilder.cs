...
public class DeckBuilder : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < AllCards.Instance.cards.Length; i++)
        {
            ...
            if (!c.token && !c.tribes.Contains(Card.Tribe.Unique) && (AllCards.Instance.heroes[deck.heroID].classes[0] == c._class || AllCards.Instance.heroes[deck.heroID].classes[1] == c._class))
            {
