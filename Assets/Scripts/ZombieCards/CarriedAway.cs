...
public class CarriedAway : Card
{
	...
	protected override IEnumerator OnThisPlay()
	{
		...
		{
			if (Tile.GetTeamTiles(team)[r, col].planted == null && (col != 4 || Tile.GetTeamTiles(team)[r, this.col].planted.amphibious))
			{
	...
	protected override IEnumerator OnSelection(BoxCollider2D bc)
	{
        ...
        yield return Tile.GetTeamTiles(team)[t.row, t.col].planted.BonusAttack();
    }
