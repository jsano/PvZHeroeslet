	...
	protected override IEnumerator OnThisPlay()
	{
		...
		if (GameManager.Instance.team == team)
		{
			...
			for (int i = 0; i < 3 && locations.Count > 0; i++) {
				...
				GameManager.Instance.PlayCardRpc(HandCard.MakeDefaultFS(AllCards.RandomFromTribe((Tribe.Gargantuar, Tribe.Gargantuar), true, locations[cur] == 4)), row, locations[cur], true);
