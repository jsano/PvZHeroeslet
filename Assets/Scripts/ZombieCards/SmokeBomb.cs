...
public class SmokeBomb : Card
{
	...
	protected override IEnumerator OnThisPlay()
	{
		...
		{
			if (Tile.GetTeamTiles(team)[row, col].planted == null && (col != 4 || Tile.GetTeamTiles(team)[this.row, this.col].planted.amphibious))
			{
	...
	protected override IEnumerator OnSelection(BoxCollider2D bc)
	{
		...
		Tile.GetTeamTiles(team)[row, col].planted.ChangeStats(1, 0);
