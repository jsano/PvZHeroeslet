...
public class Mushboom : Card
{
	...
	protected override IEnumerator OnThisPlay()
	{
		...
		if (Tile.zombieTiles[0, col].HasRevealedPlanted() && Tile.zombieTiles[0, col].planted.untrickable == 0) StartCoroutine(Tile.zombieTiles[row, col].planted.ReceiveDamage(2, this));
